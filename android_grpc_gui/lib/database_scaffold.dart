...
class _State extends State<DatabaseScaffold> {
  ...
  build(context) {
    ...
    if (table == null || database == null || stub == null) {
      return Material(
        child: ListView(
          children: [
            ListTile(
              leading: const Icon(Icons.network_cell),
              title: TextField(controller: addressController),
            ),
            ListTile(
              ...
              onTap: () {
                ...
                this.stub = DatabaseServiceClient(ClientChannel(
                  address,
                  port: 8123,
